...
pygame.display.set_icon(pygame.image.load("./paint_elements/paint_icon.png"))
...
def control_panel():
    ...
    image_of_rectangle = pygame.image.load("./paint_elements/rectangle.png")
    image_of_circle = pygame.image.load("./paint_elements/circle.png")
    image_of_ellipse = pygame.image.load("./paint_elements/ellipse.png")
    image_of_line = pygame.image.load("./paint_elements/line.png")
    image_of_palette = pygame.image.load("./paint_elements/palette.png")
