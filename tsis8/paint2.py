...
#eraser
eraser = pygame.image.load('C:\\Users\\damir\\OneDrive\\Рабочий стол\\papkaa\\pp2\\pp2_22B050873\\tsis8\\paint_elements\\eraser.png')
...
def control_panel():
    ...
    image_of_rectangle = pygame.image.load("C:\\Users\\damir\\OneDrive\\Рабочий стол\\papkaa\\pp2\\pp2_22B050873\\tsis8\\paint_elements\\rectangle.png")
    image_of_circle = pygame.image.load("C:\\Users\\damir\\OneDrive\\Рабочий стол\\papkaa\\pp2\\pp2_22B050873\\tsis8\\paint_elements\\circle.png")
    image_of_palette = pygame.image.load("C:\\Users\\damir\\OneDrive\\Рабочий стол\\papkaa\\pp2\\pp2_22B050873\\tsis8\\paint_elements\\palette.png")
    ...
    for event in pygame.event.get():
        ...
        # Choosing the color
            ...
            if StartDrawing:
                ...
                if choosed == "eraser":
                    circle(screen, white, position, math.sqrt(
                        math.pow((position[0]-x), 2)+math.pow((position[1]-y), 2)))
        if choosed == "Palette":
            # (500,180)
            if not check:
